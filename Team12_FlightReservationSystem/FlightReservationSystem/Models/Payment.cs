...
namespace FlightReservationSystem.Models
{
    ...
    {
        [Required]
        [RegularExpression("[a-zA-Z]", ErrorMessage = "Name should not contain any special characters or numbers")]
        ...
        [Required]
        [RegularExpression("[a-zA-Z]", ErrorMessage = "Street Name should not contain any special characters or numbers")]
        [StringLength(20, ErrorMessage = "Name should not contain more than 20 characters")]
        ...
        [Required]
        [RegularExpression("[a-zA-Z]", ErrorMessage = "City should not contain any special characters or numbers")]
        [StringLength(20, ErrorMessage = "City should not contain more than 20 characters")]
        [DisplayName("City")]
        public string City { get; set; }

        [Required]
        [RegularExpression("[a-zA-Z]", ErrorMessage = "Province/State should not contain any special characters or numbers")]
